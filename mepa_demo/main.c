...
char *MEPA_RELEASE_VERSION = "v2025.12-soak";
...
static mesa_rc no_phy_attach(char *parm)
{
    phy_attach = 0;
    return MESA_RC_OK;
}
...
static mscc_appl_opt_t main_phy_opt = {
    "n",
    NULL,
    "No PHY attach",
    no_phy_attach
...
static void main_init(mscc_appl_init_t *init)
{
    ...
    case MSCC_INIT_CMD_REG:
        ...
        mscc_appl_opt_reg(&main_phy_opt);
...
int main(int argc, char **argv)
{
    ...
    board_info.phy_attach = phy_attach;
