...
// Optional: provided by the external mepa_spidev_proxy dev package
// (find_package(mepa_spidev_proxy) in mepa_demo/CMakeLists.txt). When absent the
// '-P proxy:<sock>' client mode below is compiled out.
